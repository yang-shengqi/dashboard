 ...
 * ------------------------------------------------------------
 * 本版修改：
 *   ★ G10 兜底写入统一走 App.storage.setJSON（console-g10-data）
 *     —— 原为裸 localStorage.setItem('g10-data')，
 *        与 g10.js 读取的键不一致，导致兜底数据读不回
 *   ★ 清除非必要的 console.log（保留 warn / error）
 * ============================================================ */
(function (App) {
  'use strict';
  ...
  function parseWorkbook(wb) {
    ...
    /* ★ 本版修正：G10 兜底走 App.storage，与 g10.js 读取键一致 */
