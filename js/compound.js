...
(function (App) {
  ...
  function selfTest() {
    ...
    var d2 = futureValueDCA(0, 10, 10);         /* 月投 0 → 0 */
    if (d2.fv !== 0)
      fail.push('定投月投 0 应=0，实际 ' + d2.fv);

    var d3 = futureValueDCA(1000, 10, 0);       /* 年数 0 → 0 */
    if (d3.fv !== 0)
